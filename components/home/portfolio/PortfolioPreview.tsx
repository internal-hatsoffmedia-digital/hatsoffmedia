...
const portfolioCategories = [
  {
    id: "01",
    title: "Aashara Maternity",
    shortTitle: "Aashara",
    eyebrow: "Maternity / Healthcare brand",
    description:
      "A warm, premium maternity healthcare identity built to create trust, comfort, and a stronger digital-first patient experience.",
    image: "/portfolio/aashara.jpg",
    tags: ["Branding", "Healthcare", "Maternity"],
    icon: Palette,
    accent: "#FFCC00",
  },
  {
    ...
    title: "Doctor Clinic",
    shortTitle: "Doctor",
    eyebrow: "Healthcare / Clinical trust",
    description:
      "A modern clinic presence tailored for doctor visibility, patient trust, and an easy digital journey from first click to consultation.",
    image: "/portfolio/doctor.png",
    tags: ["Healthcare", "Clinic", "UX"],
    icon: Globe2,
    accent: "#FFCC00",
  },
  {
    id: "03",
    title: "Langhar Rice",
    shortTitle: "Rice Brand",
    eyebrow: "Rice / Product branding",
    description:
      "A product-first rice brand experience designed to highlight purity, quality, and premium positioning in a memorable way.",
    image: "/portfolio/langhar.jpg",
    tags: ["Branding", "Rice", "Product"],
    icon: Megaphone,
    accent: "#FFCC00",
  },
  {
    ...
    shortTitle: "Travel",
    eyebrow: "Poster campaign / Visual storytelling",
    description:
      "Travel-inspired poster visuals crafted to evoke destinations, emotion, and attention through striking graphic storytelling.",
    image: "/portfolio/traval.jpeg",
    tags: ["Poster", "Travel", "Visuals"],
    icon: Share2,
    accent: "#FFCC00",
  },
  {
    ...
    description:
      "A patient-focused digital experience designed to create confidence, accessibility, and ease for modern dental care.",
  ...
  {
    id: "06",
    title: "Smart Sales Business",
    shortTitle: "Sales Site",
    eyebrow: "B2B / Sales business website",
    description:
      "A sales-focused business website crafted to sharpen positioning, improve trust, and convert attention into qualified opportunities.",
  ...
  },
  {
    ...
    shortTitle: "Poster Series",
    eyebrow: "Campaign / Visual media",
    description:
      "A collection of poster-style visuals that turn travel moments into bold, scroll-stopping creative with clear brand presence.",
    image: "/portfolio/traval.jpeg",
    tags: ["Campaign", "Travel", "Poster"],
    icon: Palette,
    accent: "#FFCC00",
  },
];
